...
概要としては、<a href="https://github.com/vercel/satori" title="vercel/satori">vercel/satori</a>と<ExternalLink href="https://github.com/yisibl/resvg-js" title="@resvg/resvg-js">@resvg/resvg-js</ExternalLink>を使用して JSX → SVG → PNG の流れでPNGを生成しています
